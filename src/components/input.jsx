...
class Input extends Component {
    ...
    render() { 
        return <div>
            <form className='p-4'>
                <div className='mb-2'>
                    <label for='fullName' className='block pb-1'>Your fullname<span className='text-[#ef4444]'>*</span>
                    </label>
                ...
                <div>
                    <label for='email' className='block'>Email address<span className='text-[#ef4444]'>*</span>
                    </label>
